...
/**
 * Class CustomerPreorderComplete
...
class CustomerPreorderComplete extends WC_Email {
	...
	function __construct() {
		...
		$this->id          = 'dlm_email_customer_preorder_complete';
		$this->title       = __( 'Completed preorder', 'digital-license-manager' );
		$this->description = __( 'An email sent to the customer when a license key preorder is complete.', 'digital-license-manager' );

		// For admin area to let the user know we are sending this email to customers.
		$this->customer_email = true;
		$this->heading        = __( 'Preorder complete', 'digital-license-manager' );
		...
		// Template paths.
		$this->template_html  = 'emails/dlm/email-customer-preorder-complete.php';
		$this->template_plain = 'emails/dlm/plain/email-customer-preorder-complete.php';
		$this->template_base  = DLM_TEMPLATES_DIR;

		// Action to which we hook onto to send the email.
		add_action( 'dlm_email_customer_preorder_complete', array( $this, 'trigger' ) );
