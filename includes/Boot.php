...
use IdeoLogix\DigitalLicenseManager\Core\Defs\Deactivatable;
...
class Boot {
	...
	/**
	 * Initialize the deactivation feedback modal
	 * @return void
	 */
	private function initDeactivateFeedback() {

		\IgniteKit\WP\DeactivateFeedback\Boot::create()->add_plugin(new Deactivatable());
