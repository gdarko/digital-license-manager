            ...
            <table class="form-table">
                ...
                <tr scope="row">
                    ...
                    <td>
                        ...
                        <p class="description" id="tagline-description">
                            <strong><?php esc_html_e('Required.', 'digital-license-manager');?></strong>
                            <span><?php esc_html_e('i.e. for "12-AB-34-CD" the character map is <kbd>ABCD1234</kbd>.', 'digital-license-manager');?></span>
                        </p>
                    </td>
                </tr>
                ...
                <tr scope="row">
                    ...
                    <td>
                        ...
                        <p class="description" id="tagline-description">
                            <strong><?php esc_html_e('Required.', 'digital-license-manager');?></strong>
                            <span><?php esc_html_e('i.e. for "12-AB-34-CD" the number of chunks is <kbd>4</kbd>.', 'digital-license-manager');?></span>
                        </p>
                    </td>
                </tr>
                ...
                <tr scope="row">
                    ...
                    <td>
                        ...
                        <p class="description" id="tagline-description">
                            <strong><?php esc_html_e('Required.', 'digital-license-manager');?></strong>
                            <span><?php esc_html_e('i.e. for "12-AB-34-CD" the chunk length is <kbd>2</kbd>.', 'digital-license-manager');?></span>
                        </p>
                    </td>
                </tr>
                ...
                <tr scope="row">
                    ...
                    <td>
                        ...
                        <p class="description" id="tagline-description">
                            ...
                            <span><?php esc_html_e('i.e. for "12-AB-34-CD" the separator is <kbd>-</kbd>.', 'digital-license-manager');?></span>
                        </p>
                    </td>
                </tr>
                ...
                <tr scope="row">
                    ...
                    <td>
                        ...
                        <p class="description" id="tagline-description">
                            <strong><?php esc_html_e('Optional.', 'digital-license-manager');?></strong>
                            <span><?php esc_html_e('Adds a word at the start (separator <strong>not</strong> included), i.e. <kbd><strong>PRE-</strong>12-AB-34-CD</kbd>.', 'digital-license-manager');?></span>
                        </p>
                    </td>
                </tr>
                ...
                <tr scope="row">
                    ...
                    <td>
                        ...
                        <p class="description" id="tagline-description">
                            <strong><?php esc_html_e('Optional.', 'digital-license-manager');?></strong>
                            <span><?php esc_html_e('Adds a word at the end (separator <strong>not</strong> included), i.e. <kbd>12-AB-34-CD<strong>-SUF</strong></kbd>.', 'digital-license-manager');?></span>
                        </p>
                    </td>
                </tr>
