...
<h3><?php esc_html_e( 'Database Migration', 'digital-license-manager' ); ?></h3>
<p><?php esc_html_e( 'This is one-click migration tool that makes it possible to migrate from other plugins easily. Please take database backups before starting this operation.', 'digital-license-manager' ); ?></p>
<form class="dlm-tool-form dlm-tool-form--database-migration" method="POST" action="">
    <div class="dlm-tool-form-row">
        <label for="identifier"><?php esc_html_e( 'Select plugin', 'digital-license-manager' ); ?></label>
    ...
    <div class="dlm-tool-form-row">
        ...
        <button type="submit" class="button button-small button-primary"><?php esc_html_e( 'Migrate', 'digital-license-manager' ); ?></button>
    </div>
