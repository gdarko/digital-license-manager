        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
            ...
            <table class="form-table">
                ...
                <tr scope="row">
                    ...
                    <td>
                        <input id="description" class="regular-text" name="description" type="text" value="<?php echo esc_attr( $keyData->getDescription() ); ?>">
                        <p class="description">
			...
			<?php if ( 0 === (int) $keyId ): ?><?php submit_button( __( 'Generate API key', 'digital-license-manager' ), 'primary', 'update_api_key' ); ?><?php else: ?>
                <p class="submit">
                    ...
                    <a class="dlm-confirm-dialog" style="color: #a00; text-decoration: none; margin-left: 10px;" href="<?php echo esc_url(
						wp_nonce_url(
							add_query_arg(
								array(
									'action' => 'delete',
