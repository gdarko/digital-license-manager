    ...
    <div class="inside">
        <form method="post" action="<?php echo esc_html(admin_url('admin-post.php'));?>">
            ...
            <table class="form-table">
                ...
                <!-- VALID FOR -->
                <tr scope="row">
                    <th scope="row"><label for="single__valid_for"><?php esc_html_e('Valid for (days)', 'digital-license-manager');?></label></th>
                    <td>
                ...
                <!-- TIMES ACTIVATED MAX -->
                <tr scope="row">
                    <th scope="row"><label for="single__activations_limit"><?php esc_html_e('Maximum activation count', 'digital-license-manager');?></label></th>
                    <td>
