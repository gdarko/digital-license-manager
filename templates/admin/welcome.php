    ...
    <div class="dgv-instructions-card dgv-instructions-card-shadow">
        <div class="dgv-instructions-row dgv-instructions-header">
            <div class="dgv-instructions-colf">
                <p class="lead"><?php esc_html_e( 'Thanks for installing <strong class="green">Digital License Manager</strong>', 'digital-license-manager' ); ?></p>
                <p class="desc"><?php esc_html_e( 'Digital License Manager is a WordPress plugin that allows you to <strong>sell</strong> your licence keys through WooCommerce.', 'digital-license-manager' ); ?></p>
                <p class="desc"><?php esc_html_e( 'The plugin supports various features like email notifications, separate activations table, pdf certifications, import/export, WooCommerce HPOS and more.' ); ?></p>
                <p class="desc"><?php esc_html_e( 'If you found this plugin <strong>useful</strong> for your business, we will greatly appreciate if you take a minute to <a target="_blank" title="Give this plugin a good five star rating :)" href="https://wordpress.org/support/plugin/digital-license-manager/reviews/#new-post">rate it. &#9733;&#9733;&#9733;&#9733;&#9733;</a>', 'digital-license-manager' ); ?></p>
            ...
            <div class="dgv-instructions-colf">
                <div class="dgv-instructions-extra">
                    <h4 style="margin-top:0;"
                        class="navy"><?php esc_html_e( 'Need more features? try the PRO version!', 'digital-license-manager' ); ?></h4>
                    <p>
