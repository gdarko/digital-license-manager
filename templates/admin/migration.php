...
<p>
	<?php echo wp_kses(
		__( 'We detected that you used <strong>License Manager for WooCommerce</strong> previously. If you are looking to migrate to <strong>Digital License Manager</strong>, we built a tool specifically for this.', 'digital-license-manager' ),
...
<p><?php echo wp_kses( __( 'Once you finish with the migration, you can deactivate <strong>License Manager for WooCommerce</strong> safely.', 'digital-license-manager' ), \IdeoLogix\DigitalLicenseManager\Utils\SanitizeHelper::ksesAllowedHtmlTags() ); ?></p>
